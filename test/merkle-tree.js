...
test('roots get unslabbed', async function (t) {
  ...
  t.is(roots[1].hash.buffer.byteLength, rootByteLength, 'unslabbed the second root')
  t.is(roots[2].hash.buffer.byteLength, rootByteLength, 'unslabbed the third root')
})
