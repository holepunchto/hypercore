...
class BitfieldPage {
  ...
  set (index, val) {
    ...
    if (this.bitfield[i] === 0 || this.bitfield[i] === 0xffffffff) {
  ...
  firstSet (position) {
    return quickbit.indexOf(this.bitfield, true, position, this.tree)
  }

  lastSet (position) {
    return quickbit.lastIndexOf(this.bitfield, true, position, this.tree)
  }
}
