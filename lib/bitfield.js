...
var INDEX_UPDATE_MASK = [0b00111111, 0b11001111, 0b11110011, 0b11111100]
var INDEX_ITERATE_MASK = [0b00000000, 0b11000000, 0b11110000, 0b11111100]
var DATA_ITERATE_MASK = [0b10000000, 0b11000000, 0b11100000, 0b11110000, 0b11111000, 0b11111100, 0b11111110, 0b11111111]
var DATA_UPDATE_MASK = [0b01111111, 0b10111111, 0b11011111, 0b11101111, 0b11110111, 0b11111011, 0b11111101, 0b11111110]
...
for (var i = 0; i < 256; i++) {
  var a = (i & (0xf << 4)) >> 4
  var b = i & 0xf
  MAP_PARENT_RIGHT[i] = ((a === 0b1111 ? 0b11 : a === 0b0000 ? 0b00 : 0b01) << 2) | (b === 0b1111 ? 0b11 : b === 0b0000 ? 0b00 : 0b01)
  NEXT_DATA_0_BIT[i] = i === 255 ? -1 : (8 - Math.ceil(Math.log(256 - i) / Math.log(2)))
  NEXT_INDEX_0_BIT[i] = i === 255 ? -1 : Math.floor(NEXT_DATA_0_BIT[i] / 2)
}

var MAP_PARENT_LEFT = MAP_PARENT_RIGHT.map(function (n) {
  return n << 4
})
