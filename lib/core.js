...
module.exports = class Core {
  ...
  async updateRemoteContiguousLength(length) {
    ...
    // Write hints to rocks before emitting to avoid a race
    //  where emit consumers (eg keet-core getRoomInfo) query
    //  from storage before the updated hint is persisted.
    await this.flushHints()
