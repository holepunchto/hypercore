...
module.exports = class Core {
  ...
  async _verifyShared () {
    ...
    try {
      ...
      for (const { start, end, value } of ranges) {
        this.replicator._setBitfieldRanges(start, end, value)
      }
  ...
  updateContiguousLength (bitfield) {
    const contig = updateContigBatch(this.header.hints.contiguousLength, bitfield, this.replicator.localBitfield)
  ...
  onappend (tree, bitfield) {
    ...
    this.replicator._setBitfieldRanges(start, start + length, true)
  ...
  ontruncate (tree, { start, length }) {
    ...
    this.replicator._setBitfieldRanges(start, start + length, false)
