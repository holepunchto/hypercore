...
module.exports = class Core {
  ...
  async append (values, { signature, keyPair = this.header.keyPair, preappend } = {}) {
    ...
    try {
      ...
      const status = 0b0001 | updateContig(this.header, bitfield, this._bitfield)

      this._flushCoreUpdate({ status, bitfield, value: null, from: null })
