...
module.exports = class Core {
  constructor (header, compat, crypto, tree, blocks, bitfield, verifier, sessions, legacy, onupdate, onconflict) {
  ...
  static async resume (storage, opts) {
    ...
    return new this(header, compat, crypto, tree, blocks, bitfield, verifier, opts.sessions || [], legacy, opts.onupdate || noop, opts.onconflict || noop)
  }
