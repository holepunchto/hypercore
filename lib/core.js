...
module.exports = class Core {
  ...
  static async resume (oplogFile, treeFile, bitfieldFile, dataFile, headerFile, opts) {
    ...
    return new this(header, crypto, oplog, bigHeader, tree, blocks, bitfield, verifier, legacy, opts.onupdate || noop, opts.onconflict || noop)
  }
  ...
  async _fillBlocksUnsafe (values, offset, byteOffset, treeNodes) {
    const bitfield = {
      start: offset,
    ...
    await this._flushOplog() // always flush
  }
