...
module.exports = class Core {
  ...
  async _flushOplog () {
    ...
    return flushHeader(this.storage, this.header)
  }
  ...
  async clear (start, end, cleared) {
    ...
    try {
      ...
      if (this._shouldFlush()) await this._flushOplog(writer)
