...
module.exports = class Core {
  ...
  async copyPrologue (src, { additional = [] } = {}) {
    ...
    try {
      ...
      console.log('hadPending', this.wasPending)
      console.log('first five bits:', this.bitfield.get(0), this.bitfield.get(1), this.bitfield.get(2), this.bitfield.get(3), this.bitfield.get(4))
