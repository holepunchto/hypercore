...
module.exports = class Core {
  ...
  async copyPrologue (src, { additional = [] } = {}) {
    ...
    try {
      ...
      if (additional.length) {
        await this.blocks.putBatch(update.batch, srcLength, additional)
      ...
      while (segmentEnd < srcLength) {
        ...
        await this.blocks.putBatch(update.batch, segmentStart, segment)
  ...
  _createUpdate () {
    ...
    return new Update(this._activeBatch, this.bitfield, this.header)
  }
