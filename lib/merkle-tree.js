...
module.exports = class MerkleTree {
  ...
  async reconcile (tree) {
    console.log(this.length, tree.length)
    console.log(flat.fullRoots(this.length * 2), flat.fullRoots(tree.length * 2))
