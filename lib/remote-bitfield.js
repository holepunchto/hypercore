...
module.exports = class RemoteBitfield {
  ...
  setRange (start, length, val) {
    console.log('setting range', start, length, val)
  ...
  findFirst (val, position) {
    console.log('finding first', val, 'position:', position, 'max segments', this._maxSegments)
    ...
    const res = val ? -1 : this._maxSegments * BITS_PER_SEGMENT
