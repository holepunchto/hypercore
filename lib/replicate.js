...
Peer.prototype.have = function (message) {
  this.stream.send(this.channel, 0, message)
}
...
Peer.prototype.pause = function () {
  ...
  this.pausing = true
  this.stream.send(this.channel, 5, null)
}
...
Peer.prototype.onmessage = function (type, message) {
  switch (type) {
    case 0: return this.onhave(message)
    case 1: return this.onwant(message)
    case 2: return this.onrequest(message)
    case 3: return this.onresponse(message)
    case 4: return this.oncancel(message)
    case 5: return this.onpause()
    case 6: return this.onresume()
  }
}
...
Peer.prototype.ready = function () {
  ...
  process.nextTick(function () {
    self.have({
      start: 0,
      bitfield: rle.encode(self.feed.bitfield.buffer)
    })
  })
}
