...
Protocol.prototype.handshake = function (msg) {
  return this._encryptAndPush(messages.Handshake, 1, msg)
}

Protocol.prototype.active = function (msg) {
  return this._encryptAndPush(messages.Active, 2, msg)
}

Protocol.prototype.inactive = function (msg) {
  return this._encryptAndPush(messages.Inactive, 3, msg)
}

Protocol.prototype.have = function (msg) {
  return this._encryptAndPush(messages.Have, 4, msg)
}

Protocol.prototype.unhave = function (msg) {
  return this._encryptAndPush(messages.Unhave, 5, msg)
}

Protocol.prototype.want = function (msg) {
  return this._encryptAndPush(messages.Want, 6, msg)
}

Protocol.prototype.unwant = function (msg) {
  return this._encryptAndPush(messages.Unwant, 7, msg)
}

Protocol.prototype.request = function (msg) {
  return this._encryptAndPush(messages.Request, 8, msg)
}

Protocol.prototype.cancel = function (msg) {
  return this._encryptAndPush(messages.Cancel, 9, msg)
}

Protocol.prototype.data = function (msg) {
  return this._encryptAndPush(messages.Data, 10, msg)
}

Protocol.prototype.close = function (msg) {
  return this._encryptAndPush(messages.Close, 11, msg)
}
...
Protocol.prototype.ready = function (key) {
  ...
  this.push(Buffer.concat([new Buffer([24]), this.nonce]))
  this.push(encode(messages.Open, 0, {discoveryKey: this.discoveryKey}))
...
Protocol.prototype._onmessage = function (data, start, end) {
  if (!this.remoteDiscoveryKey) {
    if (!this.remoteNonce) {
      this.remoteNonce = data.slice(start, end)
      return
    }

    var open = decode(messages.Open, data, start + 2, end)
  ...
  switch (type) {
    case 0: return this._emit(this.onopen, decode(messages.Open, data, start, end))
    case 1: return this._emit(this.onhandshake, decode(messages.Handshake, data, start, end))
    case 2: return this._emit(this.onactive, decode(messages.Active, data, start, end))
    case 3: return this._emit(this.oninactive, decode(messages.Inactive, data, start, end))
    case 4: return this._emit(this.onhave, decode(messages.Have, data, start, end))
    case 5: return this._emit(this.onunhave, decode(messages.Unhave, data, start, end))
    case 6: return this._emit(this.onwant, decode(messages.Want, data, start, end))
    case 7: return this._emit(this.onunwant, decode(messages.Unwant, data, start, end))
    case 8: return this._emit(this.onrequest, decode(messages.Request, data, start, end))
    case 9: return this._emit(this.oncancel, decode(messages.Cancel, data, start, end))
    case 10: return this._emit(this.ondata, decode(messages.Data, data, start, end))
    case 11: return this._emit(this.onclose, decode(messages.Close, data, start, end))
  }
}
