...
class Peer {
  ...
  sendSync() {
    ...
    console.log(performance.now(), 'sending sync', {
  ...
  async onsync(msg) {
    ...
    console.log(performance.now(), 'sync received!', msg)
  ...
  async push(index) {
    console.log(performance.now(), 'push start...', index)
    ...
    console.log(performance.now(), 'pushing...', index)
    ...
    try {
      ...
      console.log(performance.now(), 'fulfilling push...', index)
  ...
  async _fulfillRequest(req, pushing) {
    console.log(performance.now(), 'fulfilling request...', {
    ...
    console.log(performance.now(), 'fulfilled request!', {
  ...
  async ondata(data) {
    console.log(performance.now(), 'received data', data)
  ...
  async _handleData(data) {
    console.log(performance.now(), 'handling data', data)
    ...
    console.log(performance.now(), 'verifying data', data)
    try {
      ...
      console.log(performance.now(), 'verifying data error', err)
      safetyCatch(err)
      this._unmarkInflightBlockRequest(req, data)
  ...
  async _send(req) {
    ...
    console.log(performance.now(), 'sending request...', {
      block: req.block ? req.block.index : null,
      upgrade: req.upgrade ? req.upgrade.start + req.upgrade.length : null,
      hash: req.hash ? req.hash.index : null,
      manifest: req.manifest || false
    ...
    console.log(performance.now(), 'sent request!', {
      block: req.block ? req.block.index : null,
      upgrade: req.upgrade ? req.upgrade.start + req.upgrade.length : null,
      hash: req.hash ? req.hash.index : null,
      manifest: req.manifest || false
...
module.exports = class Replicator {
  ...
  _onpeerupdate(added, peer) {
    ...
    console.log(performance.now(), 'peer-add', { publicKey: peer.remotePublicKey })
  ...
  _ondownload(index, byteLength, from, req) {
    ...
    console.log(performance.now(), 'download', { index, byteLength, req: { ...req, peer: null } })
  ...
  _onupload(index, byteLength, from) {
    ...
    console.log(performance.now(), 'upload', { index, byteLength })
  ...
  _oninvaliddata(err, req, res, from) {
    ...
    console.log(performance.now(), 'invalid-data', { err })
  ...
  _oninvalidrequest(err, req, from) {
    ...
    console.log(performance.now(), 'invalid-request', { err })
