...
module.exports = class Replicator {
  ...
  static createStream (isInitiator) {
    const p = new Protocol(isInitiator)
    p.handshake({ protocolVersion: 0, userAgent: USER_AGENT })
    return p
  }

  joinStream (protocolStream) {
    const peer = protocolStream.alias(this.core.discoveryKey, this, new RemoteState(this.core))
