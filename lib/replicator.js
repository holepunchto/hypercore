...
class Peer {
  ...
  _clearLocalRange (start, length) {
    const bitfield = this.core.skipBitfield === null ? this.replicator.localBitfield : this.core.skipBitfield
...
module.exports = class Replicator {
  ...
  _unmarkInflight (index) {
    if (this.core.skipBitfield !== null) this.core.skipBitfield.set(index, this.localBitfield.get(index))
