...
class BlockRequest extends Attachable {
  constructor (tracker, index, opts) {
    super()

    this.index = index
    this.priority = opts && opts.priority ? opts.priority : PRIORITY.NORMAL
    this.inflight = []
    this.queued = false
...
class BlockTracker {
  ...
  add (index, opts) {
    ...
    b = new BlockRequest(this, index, opts)
...
module.exports = class Replicator {
  ...
  addBlock (session, index) {
    const b = this._blocks.add(index, { priority: PRIORITY.HIGH })
