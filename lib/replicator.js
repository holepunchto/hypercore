...
class Peer {
  ...
  async push(index) {
    ...
    try {
      ...
      console.log('fulfilling push...', index)
  ...
  async _handleData(data) {
    ...
    try {
      ...
      console.log('verifying data error', err)
      safetyCatch(err)
      this._unmarkInflightBlockRequest(req, data)
...
module.exports = class Replicator {
  ...
  _onpeerupdate(added, peer) {
    ...
    console.log('peer-add', { publicKey: peer.remotePublicKey })
  ...
  _ondownload(index, byteLength, from, req) {
    ...
    console.log('download', { index, byteLength, req: { ...req, peer: null } })
  ...
  _onupload(index, byteLength, from) {
    ...
    console.log('upload', { index, byteLength })
