...
class Peer {
  ...
  async onsync(msg) {
    ...
    // we now have enough state to push
    if (hasManifest && allowPush && !this.remotePushable) {
      this.remotePushable = true
      this.pushedLength = length
    }
...
module.exports = class Replicator {
  ...
  _log (...args) {
    if (this.metrics !== null) {
      while (this.bufferedEvents.length) this.metrics.log(...this.bufferedEvents.pop())
