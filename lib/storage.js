...
function Storage (create) {
  ...
  this.treeSignatures = create('tree.signatures')
}
...
Storage.prototype.getSignature = function (index, cb) {
  this.treeSignatures.read(64 * index, 64, function (err, signature) {
    if (err) return cb(err)
...
Storage.prototype.putSignature = function (index, signature, cb) {
  this.treeSignatures.write(64 * index, signature, cb)
}
...
Storage.prototype.getNode = function (index, cb) {
  ...
  this.tree.read(40 * index, 40, function (err, buf) {
    if (err) return cb(err)
...
Storage.prototype.putNode = function (index, node, cb) {
  ...
  this.tree.write(40 * index, buf, cb)
}
...
Storage.prototype.open = function (cb) {
  ...
  readAll(this.bitfield, function (err, data) {
