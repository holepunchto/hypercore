...
const manifestv1 = exports.manifestv1 = {
  preencode (state, m) {
    state.end++ // flags
...
const manifest = exports.manifest = {
  preencode (state, m) {
    ...
    if (m.version === 1) return manifestv1.preencode(state, m)
  ...
  encode (state, m) {
    ...
    if (m.version === 1) return manifestv1.encode(state, m)
  ...
  decode (state) {
    ...
    if (version === 1) return manifestv1.decode(state)
